...
const UpdateStudentModal = props => {
    ...
    const handleSubmit = e => {
        e.preventDefault();
        updateStudent(props.student.studentId, e.target).then((result) => {
            MySwal.fire(result, '', 'success');
            props.setUpdated(true);
            props.onHide();
        }, (error) => {
            MySwal.fire("Failed to Update Student", '', 'error');
        })
    };
                        ...
                        <Col sm={6}>
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Form.Group controlId="Email">
                                    ...
                                    <Form.Control type="Email" name="Email" required defaultValue={props.student.Email} placeholder="" />
                                </Form.Group>
